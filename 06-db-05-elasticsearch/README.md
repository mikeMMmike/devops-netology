...
```
Видно, что шарды индексов находятся в состоянии "Не назначено", т.к. при создании не были указаны реплики в назначении шард. Наш сервис находится в single-mode режиме. Выходит, что в данном режиме нет смысла создавать шарды.
