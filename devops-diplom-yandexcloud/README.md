...
<details><summary>В случае, если пароль не устанавливается ролью ansible, необходимо подключиться к серверу gitlab и сменить пароль</summary>
```bash
...
```
Сделаем commit в ветку master. Pipeline успешно отработал:
![](src/screenshots/pipeline_in_a_hole_2022-08-14_18-39-04.png)

На доставку изменений потребовалось около 2 секунд. Обновляем страницу https://mycompanyname.ru/ и проверяем изменения. Их видно сразу:
![](src/screenshots/CI-CD_in_a_hole_2022-08-14_18-36-24.png)
...
### Задачи и описание дипломного проекта
