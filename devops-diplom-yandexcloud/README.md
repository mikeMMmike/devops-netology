...
Итак, шаг номер раз. Добавление А-записей в DNS нашей доменной зоны:

![](src/screenshots/dns-a.png)

Шаг номер следующий. Создание ВМ с nginx и letsencrypt. Воспользуемся предварительным конфигом вм из предыдущего пункта диплома,
